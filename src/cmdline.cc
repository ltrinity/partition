...
const char *args_info_purpose = "CParty partition function";

const char *args_info_usage = "Usage: CParty"  "[options] [sequence]";

const char *args_info_versiontext = "";

const char *args_info_description = "Read RNA sequence from stdin or cmdline; compute partition function using \nRNA folding algorithm CParty";
...
{
  printf (" %s\n",(strlen(package_name) ? package_name : "cparty"));
